...
@section('content')
            <div class="container py-5">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-lg-8">
                        <h2 class="display-5 fw-bold text-primary mb-3">Mengapa AppName?</h2>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="custom-card p-4 text-center">
                            ...
                            <h5 class="fw-bold text-primary">Otomatisasi Penuh</h5>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="custom-card p-4 text-center">
                            ...
                            <h5 class="fw-bold text-primary">Analisis Real-Time</h5>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="custom-card p-4 text-center">
                            ...
                            <h5 class="fw-bold text-primary">Kolaborasi Tim</h5>
